...
def start_game(SECRET_WORD):
  ...
  while (gr > 0):
    ...
    if len(user_g) != 5:
      print(f"You guessed {user_g}; this is invalid because it is not 5 characters long. Please try again. You have {gr} guesses remaining.")
      continue
...
const reqCode = `termcolor==1.1.0
`;

const wordsCode = `which
there
their
about
would
...
export default function App() {
  ...
  return (
    <div className="p-6 w-full h-full max-h-full	">
      <div className="grid justify-content-between">
        <h1>cmdl Wordle</h1>
        {seconds > 30 && seconds % 5 === 0 ? <MakeCircle /> : <div></div>}
      </div>
      <TabView
        activeIndex={activeIndex}
        onTabChange={(e) => setActiveIndex(e.index)}
      >
        <TabPanel header="main.py">
          <Code code={mainCode} language="py" />
        </TabPanel>
        <TabPanel header="genword.py">
          <Code code={genwordCode} language="py" />
        </TabPanel>
        <TabPanel header="requirements.txt">
          <Code code={reqCode} language="txt" />
        </TabPanel>
        <TabPanel header="sgb-words.txt">
          <Code code={wordsCode} language="txt" />
        </TabPanel>
      </TabView>
    </div>
  );
...
function Code({ code, language }) {
  ...
  return (
    <div className="Code">
      <pre className="line-numbers" style={{ maxHeight: "65vh" }}>
